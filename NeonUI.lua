...
local Player = Players.LocalPlayer-- NeonUI Library - A unique neon-themed UI library for Roblox
-- Created with distinctive visual styling and smooth animations
-- Mobile-optimized version
...
function NeonUI:CreateWindow(title, subtitle)
    ...
    -- Completely rebuilt minimize button with proper neon styling
    ...
    CreateStroke(minimizeButton, Config.Colors.Primary, 2)
    AnimateHover(minimizeButton, Color3.fromRGB(0, 200, 200), Config.Colors.Primary)
    
    -- Close Button
    local closeButton = Instance.new("TextButton")
    closeButton.Name = "CloseButton"
    closeButton.Parent = titleBar
    closeButton.BackgroundColor3 = Config.Colors.Primary
    ...
    CreateStroke(closeButton, Config.Colors.Primary, 2)
    AnimateHover(closeButton, Color3.fromRGB(0, 200, 200), Config.Colors.Primary)
    
    -- Create tab scroll frame and content frame first before minimize functionality
    ...
    tabScrollFrame.ElasticBehavior = Enum.ElasticBehavior.Never
    ...
    tabLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
        local contentWidth = tabLayout.AbsoluteContentSize.X + 10
    ...
    -- Completely rebuilt minimize functionality with proper state management
    ...
    minimizeButton.MouseButton1Click:Connect(function()
        ...
        if isMinimized then
            ...
            TweenService:Create(mainFrame, TweenInfo.new(Config.Animations.Fast), {
    ...
    -- Completely rebuilt dragging system with proper X and Y axis movement
    local dragging = false
    local dragStart = nil
    local startPos = nil
    
    -- Make title bar draggable (excluding buttons)
    local dragArea = Instance.new("Frame")
    dragArea.Name = "DragArea"
    dragArea.Parent = titleBar
    dragArea.BackgroundTransparency = 1
    dragArea.Size = UDim2.new(1, -100, 1, 0)  -- Exclude button area
